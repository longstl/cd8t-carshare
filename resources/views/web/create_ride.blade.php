                ...
                <div class="col_half">
                    ...
                    <div class="contact-widget">
                        ...
                        <form class="nobottommargin" id="template-contactform" name="template-contactform"
                              action="{{route('saveRide')}}" method="post">

                            <div class="form-process"></div>

                            <div class="col_two_third">
                                <label for="origin-input">Origin</label>
                                <input type="text" id="origin-input" name="origin_address" value=""
                            ...
                            <div class="col_two_third">
                                ...
                                <div class="form-group">
                                    <div class="input-group tleft" data-target-input="nearest"
                                        ...
                                        <input type="text" name="travel_start_time"
                                               class="form-control datetimepicker-input datetimepicker"
                                               data-target=".datetimepicker" placeholder="MM/DD/YYYY 00:00 AM/PM"/>
                            ...
                            <div class="col_one_third">
                                ...
                                <select id="select_vehicle" name="rider"
                                        class="form-control form-select selectpicker sm-form-control">
                            ...
                            <div class="col_full">
                                <button name="submit" type="submit" id="submit-button" tabindex="5" value="Submit"
                                        class="button button-3d nomargin">Create
                                </button>
                                <button name="submit" type="submit" id="submit-button" tabindex="5" value="Submit"
                                        class="button button-3d nomargin">Remove
                                </button>
                            </div>
                        </form>
                    </div>
