...
<header id="header" class="transparent-header dark full-header" data-sticky-class="not-dark" style="background-color: rgba(0,0,0,0)">
    <div id="header-wrap">
        <div class="container clearfix">
            ...
            <i style="font-size: 25px;float: right;" class="fa fa-bars menu-bars-icon iconbar" aria-hidden="true"></i>
            <nav id="primary-menu" class="menu_top">
                ...
                <div class="position-relative" id="top-search" style="width: 150px">
                    ...
                    <div style="width: 20%;float: left">
                        <a>
                            <i style="font-size: 20px;cursor: pointer" class="fa fa-bell" aria-hidden="true">
                ...
                @if(\Illuminate\Support\Facades\Auth::check())
                    <div id="account" class="accountn" style="border-top: 2px solid #1ABC9C;box-shadow: 0 2px 4px rgb(0 0 0 / 20%), 0 -1px 0px rgb(0 0 0 / 2%);width: 130px;color: black; background-color: #ffffff;position: absolute;  top: 100%; right: 87px;">
                        <div style="padding: 5px;border-bottom: 1px solid rgba(0,0,0,0.1)" class="log-hover">
                            <a href="{{route('profile_user')}}" style="display: inline-block;text-align: center;-ms-touch-action: manipulation;border: 1px solid transparent;padding: 6px 12px;line-height: 1.42857143;width: 100%;;color: black;margin-right: 5px"><b>Profile<i style="padding-left: 5px" class="fas fa-id-badge"></i></b></a>
                        </div>
                        <div style="padding: 5px" class="log-hover">
                            <a href="{{route('logoutUser')}}" style="display: inline-block;text-align: center;-ms-touch-action: manipulation;border: 1px solid transparent;padding: 6px 12px;line-height: 1.42857143;width: 100%;color: black"><b>Logout<i class="fas fa-sign-out-alt" style="padding-left: 5px"></i></b></a>
                        </div>
                    </div>
                @endif
            </nav>
