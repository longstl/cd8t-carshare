    ...
    <div id="header-wrap">
        <div class="container clearfix">
            ...
            <nav id="primary-menu" class="menu_top">
                ...
                <div id="account" class="accountn" style="position: absolute;bottom: -50px;right: 10px"><a href="" class="btn btn-success " style="margin-right: 5px">Login</a><a href="" class="btn btn-warning">Register</a></div>
            </nav>
        </div>
    </div>
</header>
